...
<head>
    ...
    <div class="corpo">
        ...
        <div class="conteudo">
            <fieldset style="width: 880px; margin: 5px;">
                <legend id="title">Saidas de Insumos</legend>
    ...
    <tr>
      ...
      <?php while ( $row = $result->fetch_assoc() )  echo '<tr><td>', $row['cod'], '</td><td>', $row['data'], '</td><td> ', $row['codproduto_insumo'], '</td><td> ', $row['codcliente'], '</td><td> ', $row['quantidade'], '</td> <td>',  $row['valorunit'], '</td><td>', 'R$ ', $valortotal = $row['quantidade']*$row['valorunit'], '</tr>'; ?> 
  </table>
            </div>
    <br>
            
                    <a href="saidas.php"><input id="but1" type="button" value="Voltar"></a>
                <a href="vendainsumo.php"><input id="but1" type="button" value="Novo produto"></a>
                <a href="del/vendainsumo.php"><input id="but7" type="button" value="Deletar produto"></a>                
            </fieldset>
                <br>
        <br>
        </div>
