...
<head>
    ...
    <div class="corpo">
        ...
        <div class="conteudo">
            ...
            <form action="insert/vendapneu.php" method="POST" style="border: 1px solid; width: 480px; margin: 10px;">
            <fieldset>
            <legend id="title">Registrar saída de pneu</legend>
                <table>
    ...
    <tr><td>Produto: </td>
        <td><select  name="codprodutopneu" required>
            <option>Selecione</option>
    <?php 
    $sql = 'SELECT cod, veiculo FROM produto_pneu';
 
    // Printing results
    $result = $mysqli->query( $sql );
    while ( $row = $result->fetch_assoc() )  echo '<option>',$row['cod'], ' | ', $row['veiculo'], '</option>'?>        
            </select></td></tr>                    
    <tr><td>Quantidade</td>
...
maxlength="8" value="0.00" required></td></tr>
        ...
        <br>
        <a href="saidaspneu.php"><input type="button" id="but1" value="Voltar"></a>    
