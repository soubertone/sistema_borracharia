...
<head>
    ...
    <title>Shangrila Sistemas - Estoque</title>       
    </head>
    ...
    <div class="corpo">
        ...
        <div class="conteudo">
            <fieldset style="width: 880px; margin: 5px;">
                <legend id="title">Selecione estoque</legend>
            
                <a href="estoquepneu.php"><input id="but4" type="button" value="Estoque de pneus"></a>

            <a href="estoqueinsumo.php"><input id="but4" type="button" value="Estoque de insumos"></a>
