...
$sql = 'SELECT cod FROM venda_pneu';
...
<head>
    ...
    <title>Shangrila Sistemas - Deletar Produtos</title>       
    </head>
    
    <body>
        
    <div class="cabecalho">
        <h2> Shangrila Sistemas - Deletar registro</h2>
    ...
    <br>
            <div class="del">
            <form action="deletarvendapneu.php" method="POST" style="border:1px solid; " dir="ltr">
                  <fieldset>
    ...
    <?php 
            while ( $row = $result->fetch_assoc() )  echo '<option>', $row['cod'], '</option>'
