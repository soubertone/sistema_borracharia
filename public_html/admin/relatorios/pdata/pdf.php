<?php	
	...
	$html .= '<legend id="ltitle">Relatório de Seviços por Data</legend>';
	...
	$result = "SELECT * FROM regservico WHERE data >= ('$datade') AND data <= ('$dataate');";
	...
	$html .= '</table>';
	$html .= '</fieldset>';
	$soma = "SELECT SUM(valortotal) FROM regservico WHERE data >= ('$datade') AND data <= ('$dataate');";
