<?php
    ...
    $codprodutoinsumo = $_POST['codprodutoinsumo'];
    ...
    $resultado = "INSERT INTO venda_insumo (data, codproduto_insumo, quantidade, valorunit, codcliente) VALUES ('$data', '$codprodutoinsumo', '$quantidade', '$valorunit', '$codcliente')";
    $result = mysqli_query($mysqli, $resultado);

     echo  "<script type='text/javascript'>
    				alert('Compra registrada!');location.href='../vendainsumo.php'
    	</script>";
